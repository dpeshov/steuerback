...
export default function ApplicationPage() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-2xl font-black text-brand-navy tracking-tight">New application</h1>
        <p className="text-gray-400 text-sm mt-0.5">Pick the year you worked in Germany</p>
      </div>
      ...
      <div className="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm">
            ...
            return (
              <button
                ...
                className={`relative py-5 rounded-2xl font-black text-xl transition-all duration-200 ${
                  selected
                    ? 'bg-brand-navy text-white shadow-xl shadow-brand-navy/20 scale-[1.02]'
        ...
        <div className="bg-[#F8F9FA] rounded-2xl p-4 mb-5">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-xs font-bold text-brand-navy uppercase tracking-wide">What you will need</span>
          </div>
        ...
        {error && (
          <div className="mb-4 bg-red-50 border border-red-100 text-brand-red text-sm px-4 py-3 rounded-xl">
            {error}
          </div>
        )}
        ...
        >
          ...
          {!loading && taxYear && <ArrowRight size={16} />}
        </button>
      </div>

      <p className="text-center text-xs text-gray-400">
        You can have one application per tax year. Filing is free to start.
      </p>
    </div>
  )
}
